    ...
    public partial class FrmAlumnos : Form
    {
            ...
            if (rjTextBox1.Texts != "")
            {
                ...
                if (hasOnlyDNINum)
                {
                    if (rjTextBox2.Texts != "")
                    {
                        ...
                        bool hasOnlyLetters = regexLetters.IsMatch(rjTextBox2.Texts);
                        Regex regexSpace = new Regex(@"\s+");
                        bool hasSpaces = regexSpace.IsMatch(rjTextBox2.Texts);
                        if (hasOnlyLetters || hasSpaces)
                        {
                            if (rjTextBox3.Texts != "")
                            {
                                hasOnlyLetters = regexLetters.IsMatch(rjTextBox3.Texts);
                                                ...
                                                if (IsValidEmail(rjTextBox4.Texts))
                                                {
                                                    if (rjTextBox5.Texts != "")
                                                    {
                                                        if (IsValidEmail(rjTextBox5.Texts))
                                                        {
                                                            ...
                                                            {
                                                                msgSuccesful("Se ha agregado el alumno satisfactoriamente");
                                                                negocio.MostrarTabla(dataGridView1, Tabla);
                                                                SetEmpty();
                                                                SetPlaceHolder();
                                                            }
        ...
        private void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            if (rjTextBox1.Texts != "")
            {
                ...
                if (negocio.Borrar(p))
                {
                    msgSuccesful("Se ha borrado el alumno satisfactoriamente");
                    negocio.MostrarTabla(dataGridView1, Tabla);
                    SetEmpty();
                    SetPlaceHolder();
                }
                ...
                {
                    msgError("No existe el Alumno que se deasea borrar");
                }
            }
            else
            {
                                                ...
                                                if (IsValidEmail(rjTextBox4.Texts))
                                                {
                                                    if (rjTextBox5.Texts != "")
                                                    {
                                                        if (IsValidEmail(rjTextBox5.Texts))
                                                        {
                                                            ...
                                                            {
                                                                msgSuccesful("Se ha modificado el alumno satisfactoriamente");
                                                                negocio.MostrarTabla(dataGridView1, Tabla);
                                                                SetEmpty();
                                                                SetPlaceHolder();
                                                            }
                                                            ...
                                                            {
                                                                msgError("No existe el Alumno que se desea Modificar");
                                                            }
                                                        }
                                                        else
                                                        {
